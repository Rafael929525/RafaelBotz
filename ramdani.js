...
module.exports = Ramdani = async (Ramdani, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = Ramdani.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "© ʙʏ ʀᴀғᴀᴇʟ","listType": "SINGLE_SELECT","sections": list}}, {})
...
"externalAdReply": {
                ...
                "body": `${faketroli}`,
                "mediaType": "10",
                "mediaUrl": `https://youtube.com/channel/UCAKsS8Qo1pTndjVHvN_G7pQ`,
                "thumbnailUrl": "https://youtube.com/channel/UCAKsS8Qo1pTndjVHvN_G7pQ",
                "thumbnail": fakeimg,
                "sourceUrl": `https://youtube.com/channel/UCAKsS8Qo1pTndjVHvN_G7pQ`,
      ...
      const demoteAdmin = async function(to, target=[]){
          ...
          if (!packname) packname = 'Dibuat Oleh'; if (!author) author = '© Rafael';author = author.replace(/[^a-zA-Z0-9]/g, '');	
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/foto/thumb.jpg`)},"title": `© ʙʏ ʀᴀғᴀᴇʟ`,"description": "Rafael", "currencyCode": "IDR","priceAmount1000": "999999","retailerId": "Rafael","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
...
danzrun = process.uptime() 
           Ramdani.setStatus(`${namabot} Aktif Selama ${(danzrun)} © Creator By Rafael`).catch((_)=>_); //DI UBAH YATIMM
...
break
       ...
       if (isBanned) return freply(mess.banned)
               ...
               buttons = [{buttonId: `${prefix}gopay`,buttonText:{displayText: 'GO-PAY'},type:1},{buttonId: `${prefix}dana`,buttonText:{displayText: 'DANA'},type:1}]
...
> ❏ ${prefix}nsfw_avatar`
               ...
               buttonsMessage = {
               contentText: `${allmenu}`,
               footerText: '© ʙʏ ʀᴀғᴀᴇʟ', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
❏ GITHUB CREATOR : https://github.com/Rafaell
❏ YT CREATOR : https://youtube.com/channel/UCAKsS8Qo1pTndjVHvN_G7pQ
*━━━━━━━━━━━━━━━━━━━━*`)
randommusic = fs.readFileSync(`./media/audio/${randomaudio}.mp3`)
Ramdani.sendMessage(from, randommusic, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
...
// SOSMET          
      ...
      if (!isRegist) return freply(mess.regist)
      if (isBanned) return freply(mess.banned)
             freply(`Follow Instagram Owner Ya : https://www.instagram.com/rafael929525`)
             break
//casee nya
case 'grupbot':
case 'groupbot':
...
case 'tiktok':
              ...
              buttonsMessage = {footerText:'Jangan Lupa Subscribe Yt Rafael\n Help 1k subscriber', imageMessage: imageMsg,
       ...
       case 'img2url':
         ...
         case 'asupan':
              ...
              .then(async (body) => {
               ...
               sendMediaURL(from, `http://sansekai.my.id/ptl_repost/${asupanx}`, '\`\`\`ASUPAN BRO GUA DAPAT DARI Rafael\`\`\`')
...
case 'ttp':
              if (!isRegist) return freply(mess.regist)
              if (isBanned) return freply(mess.banned)
              if (args.length == 0) return freply(`Example: ${prefix + command} Rafael`)
              woy = args.join(" ")
              freply(mess.wait)
...
//------------------<18+ Menu>-----------------------   
       case 'randombokep':
              ...
              Ramdani.sendMessage(from, '*PERMINTAAN:* '+bokep+'\n*DOSA TANGGUNG PRIBADI*\n*NI BRO FREE BUAT KAMU DOWNLOAD SENDIRI:* '+ kep, text, { quoted: ftoko, caption: `NI BOKEP SAYA DAPAT DARI *© ʙʏ ʀᴀғᴀᴇʟ* DOSA TANGGUNG SENDIRI🗿`})
              break
                case 'xnxx':
              if (!isRegist) return freply(mess.regist)
              if (isDewasa) return freply(mess.dewasa)
...
Ramdani.sendMessage(from, tapib1, document, { quoted: mek, filename:`Rafael ~ 404 ${danz}.mp3`, mimetype: 'audio/application' })
...
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
              freply(`*Subcribe YT Owner :*\n https://youtube.com/channel/UCAKsS8Qo1pTndjVHvN_G7pQ`)
              break
case 'y': 
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
...
Ramdani.sendMessage(_.jid, 
      ...
      case 'broadcastgroup': 
             ...
             for (let _ of anu) {
Ramdani.sendMessage(_.jid, 
			{"contentText": `*「 SIARAN RAFAEL BOTZ」*\n*Izin Siaran Ngap:v*\n*Pesan :* ${body.slice(4)}`,
			"footerText": '© ʙʏ ʀᴀғᴀᴇʟ',
			"buttons": [
			{"buttonId": `${prefix}menu`,
			"buttonText": {"displayText": "MENU"
